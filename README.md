...
Skeletal muscle T2 is a key biomarker for evaluating inflammation, edema, and fat infiltration. Recently, single-sided NMR relaxometry methods have been developed to overcome the limitations of clinical MRI scanners. However, portable single-sided NMR devices often suffer from signal interference caused by the superficial subcutaneous fat layer. To solve this, we developed a portable single-sided NMR device built with a barrel and bar permanent magnet architecture that projects a magnetic field into tissue. A surface meander gradient coil driven by a modified CPMG sequence actively dephases superficial spins, suppressing fat signals to isolate the underlying muscle response.
